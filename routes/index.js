...
router.get('/yyy', function (req, res) {
  ...
  //   tall("https://ekaro.in/enkr2020051241852771", {
  //                         method: 'HEAD',
  //                         maxRedirect: 10
  //                       }).then(function(unshortenedUrls){ 
  //                         console.log('unshortenedUrls: ', unshortenedUrls);
  //                         tall(unshortenedUrls, {
  //                           method: 'HEAD',
  //                           maxRedirect: 10
  //                         }).then(function(unshortenedUrlsxx){ 
  //                           tall(unshortenedUrlsxx, {
  //                             method: 'HEAD',
  //                             maxRedirect: 10
  //                           }).then(function(xyz){ 
  //                             console.log('xyz: ', xyz);
  ...
  // var post_img =req.query.id;
 let  post_img = "https://cdn5.telesco.pe/file/UIYu_0BfYw2ARNFlk6fiV0Qwkx2EKtPS5kHrIyJ0RN55U7V5DTZqoUvDs9JyfW4sJNTDsJeG1pRClXaID6k3l8BIyjRYDK_wL0rayInb8lCQ0mQC8ssW1HxxwvhuVHU4F4-YKjSX-h4tviSpKnQCwDxxiue4dTjn4OkgbvglLu_YuzfSx4sIR2tCCTRtrn2fU5S9S9vyXh1PG4oVVhMxxvBBGKp3mA2EqHjP3h0yPW_FZYkuNC-0ZW0hTbVbLsynDbpFvRS2Jyey_NuMum5nNTKN5MjsftzI13ETn1eXP9yx0pto91dTifSMJTH2-2bxIx9swRmDGlUNFAVkLQUjDw.jpg"
